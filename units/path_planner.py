...
class PathPlanner():
    ...
    def getPaths(self, segments):
        ...
        filtered_lanes = [l for l in lanes if self.is_lane_inside_driveable(l.mask, driveable_mask)]
        ...
        mins = [l.offset for l in filtered_lanes if l.is_right and l.cls == "Impassable"]
        if len(mins) > 0:
